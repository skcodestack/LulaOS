/*
 * Standard VGA 8x16 bitmap font (CP437 compatible)
 * Each character: 8 pixels wide x 16 pixels tall
 * Each row is 1 byte, MSB = leftmost pixel
 * Only printable ASCII (32-126) defined; others are zero-filled
 */
const unsigned char font_8x16[256][16] = {
    ...
    [89] = { 0x00,0x00,0xC6,0xC6,0xC6,0x6C,0x38,0x18,0x18,0x18,0x18,0x3C,0x00,0x00,0x00,0x00 }, /* Y */
    ...
    [118]= { 0x00,0x00,0x00,0x00,0x00,0xC6,0xC6,0xC6,0xC6,0x6C,0x38,0x10,0x00,0x00,0x00,0x00 }, /* v */
